...
require File.expand_path('./../retro/query', __FILE__)
...
require File.expand_path('./../retro/client/path_finder', __FILE__)
require File.expand_path('./../retro/server_message', __FILE__)
require File.expand_path('./../retro/managers/room_manager', __FILE__)
require File.expand_path('./../retro/managers/room_type_manager', __FILE__)
require File.expand_path('./../retro/managers/room_category_manager', __FILE__)
require File.expand_path('./../retro/managers/item_manager', __FILE__)
require File.expand_path('./../retro/managers/user_manager', __FILE__)
require File.expand_path('./../retro/managers/furni_definition_manager', __FILE__)
require File.expand_path('./../retro/managers/catalog_page_manager', __FILE__)
require File.expand_path('./../retro/managers/catalog_item_manager', __FILE__)
require File.expand_path('./../retro/repository', __FILE__)
